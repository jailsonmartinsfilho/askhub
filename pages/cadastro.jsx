...
export default function Cadastro() {
    ...
    const cadastrar = async (event) => {
        ...
        .then(response =>{
            ...
            if (response.data == 'Cadastro realizado com sucesso!') return console.log(response.data)
        });
    }
                ...
                <div className={styles.cadastroContainer}>
                    ...
                    <div className={styles.inputsContainer}>
                        <div className={styles.inputContainer}>
                            <input value={nomeusuario} onChange={(event) => setNomeUsuario(event.target.value)} className={styles.input}type="text" id="nome" name="nome" placeholder='Nome de usuário' minLength={3} maxLength={20} pattern="[A-Za-z0-9]+"/>
                        </div>
                        ...
                        <div className={styles.inputContainer}>
                            <input value={confirmarSenha} onChange={(event) => setConfirmarSenha(event.target.value)} className={styles.input}type="password" id="confirmpassword" name="confirmpassword" placeholder='Confirmar senha' minLength={8} maxLength={100} pattern="[A-Za-z0-9]+"/>
                        </div>
                        ...
                        <button onClick={cadastrar} className={styles.buttonCadastrar}>Cadastrar</button>
                    </div>
                </div>
            </section>
