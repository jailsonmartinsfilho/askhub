...
import GoogleCustomButtonCadastrar from '../components/GoogleCustomButtonCadastrar/GoogleCustomButtonCadastrar';
EmailButtonCadastrar
import EmailButtonCadastrar from '../components/EmailButtonCadastrar/EmailButtonCadastrar';
            ...
            <section className={styles.mainContainer}>
                <section className={styles.centralContainer}>
                    ...
                    <div className={styles.cadastroContainer}>
                        ...
                        <EmailButtonCadastrar botaoEmailClicado={botaoEmailClicado} onClick={() => setBotaoEmailClicado(true)} />
                        <GoogleCustomButtonCadastrar botaoEmailClicado={botaoEmailClicado} />
